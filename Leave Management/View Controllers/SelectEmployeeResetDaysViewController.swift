//
//  SelectEmployeeResetDaysViewController.swift
//  Leave Management
//
...
class SelectEmployeeResetDaysViewController: UIViewController,  UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EmployeeCell_") as! UITableViewCell
        ...
        if let _token = token {
            ...
            AF.request(baseURL, headers: headers).responseJSON { response in
                ...
                case .failure(let error):
                    ...
                    let alert = UIAlertController(title: nil, message: "Unfortunately, we couldn't fetch employees", preferredStyle: UIAlertController.Style.alert)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let resetDaysMVC = segue.destination as? ResetEmployeeDaysViewController {
            resetDaysMVC.employeeId = employees![(lastSelection?.row)!].id
            resetDaysMVC.employeeName = employees![(lastSelection?.row)!].name
            lastSelection = nil
