...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var drawerController     = KYDrawerController(drawerDirection: .left, drawerWidth: 300)
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if(UserDefaults.standard.isLoggedIn()) {
            ///: Go To Pending Leaves View Controller
            let storyboard = UIStoryboard(name: "Main", bundle: nil)

            if (UserDefaults.standard.isHR()) {
                let mainVC = storyboard.instantiateViewController(withIdentifier: "NavPendingLeaveRequests")
                let menuVC = storyboard.instantiateViewController(withIdentifier: "HRDrawer")
            ...
            //TODO Show LogIn View Comtroller
        }
